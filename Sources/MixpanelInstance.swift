...
open class MixpanelInstance: CustomDebugStringConvertible, FlushDelegate, AEDelegate {
    ...
    /// Controls whether to use GZIP compression for request payloads.
    /// Enabling this option can significantly reduce the size of network requests.
    /// Defaults to false.
    open var useGzipCompression = false {
        didSet {
